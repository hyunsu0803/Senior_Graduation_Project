...
class MyWindow(QOpenGLWidget):
    ...
    def mousePressEvent(self, e):
        ...
        elif e.buttons() and qtcore.Qt.RightButton:
            click = True
            left = False
        self.update()
    ...
    def mouseReleaseEvent(self, e):
        ...
        if e.buttons() and (qtcore.Qt.RightButton or qtcore.Qt.LeftButton):
            click = False
        self.update()
...
'''TODO:
    1. add new joint to global joint list
    2. set new joint's chaneel
    3. set new joint's child joints
'''
